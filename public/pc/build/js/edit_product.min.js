...
var fileurl = $('#upload-file').data('file');
...
$(function () {
    ...
    var $cover = Qiniu.uploader({
        ...
        init: {
            'UploadProgress': function UploadProgress(up, file) {
                var $tip = $('#upload-cover').find('span');
    ...
    var $videocover = Qiniu.uploader({
        ...
        init: {
            'UploadProgress': function UploadProgress(up, file) {
                var $tip = $('#upload-videocover').find('span');
    ...
    layui.use('form', function () {
        ...
        form.on('select(class)', function (data) {
            $(data.elem).find('option').map(function (index, item) {
        ...
        form.on('submit(submit)', function (data) {
            var content = zhContent.txt.html();
            var encontent = enContent.txt.html();
            var cover = $('.img-cover').attr('src');
            var videocover = $('.img-videocover').attr('src');
            ...
            if (data.field.video) {
                if (!videocover) {
                    layer.msg('必须添加视频封面图片', function () {});
                    return false;
                }
            }

            if (!classid) {
                layer.msg('必须选择产品所属分类', function () {});
                return false;
            } else {
            ...
            if (!data.field.content) {
                layer.msg('中文内容不能为空', function () {});
                return false;
            }

            if (!data.field.encontent) {
                layer.msg('英文内容不能为空', function () {});
                return false;
            }
